...
def get_current_server():
    global _server
    host = "3.235.134.202"
    _server = _server or Server(host,"ubuntu","C:/Users/keema/Downloads/LightsailDefaultKey-us-east-1.pem")
    return _server
...
def test_get_running_processes():
    ...
    assert '/usr/sbin/cron -f' in processes
    assert "this-is-a-fake-process-name" not in processes
